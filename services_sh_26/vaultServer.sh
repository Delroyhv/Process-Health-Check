...
openssl pkcs12 -nodes -in $PKCS_FILE -legacy -passin pass: -nocerts -out $PRIVATE_KEY_FILE
openssl pkcs12 -nodes -in $PKCS_FILE -legacy -passin pass: -nokeys -out $CERT_FILE
