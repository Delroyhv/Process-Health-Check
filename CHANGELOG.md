...
- docs/gsc_airgap.md, docs/gsc_airgap.pdf: Generated by `make docs`.
- README.md: Add "Air-Gapped Deployment" section with four-step workflow and full flag reference.
